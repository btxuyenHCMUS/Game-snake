...
HANDLE hCon = GetStdHandle(STD_OUTPUT_HANDLE); //lay consle cua so hien hanh

											   //dua con tro den toa do xy
...
//thiet lap che do hien thi fullscreen
...
//ham xoa toan bo mang hinh consle
...
//viet lai ham cho de nhin
void clrscr()
{
	cls(hCon);
}

//an hien con tro trong consle
